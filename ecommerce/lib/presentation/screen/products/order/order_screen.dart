...
import 'package:ecommerce/presentation/screen/products/order/adress_screen.dart';
import 'package:ecommerce/presentation/screen/products/order/successfull_orders_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Passez votre commande',style: TextStyle(color: whiteColor),),
      ),
      body: ListView(
        children: [
          Padding(
