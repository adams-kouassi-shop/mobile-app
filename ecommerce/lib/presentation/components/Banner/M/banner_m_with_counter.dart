...
import 'package:ecommerce/presentation/components/blur_container.dart';
...
class BannerMWithCounter extends StatefulWidget {
  const BannerMWithCounter({
    super.key,
    this.image = "assets/images/banner_1.jpg",
    required this.text,
    ...
    return BannerM(
      ...
      children: [
        Column(
          ...
          children: [
            Text(widget.text, textAlign: TextAlign.center, style: const TextStyle(fontFamily: grandisExtendedFont, fontSize: 24, fontWeight: FontWeight.w500, color: Colors.white,),
            ),
