          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text("Basé sur $numOfReviews avis"),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(
            width: 50,
            child: Text("$star Étoile",
              style: Theme.of(context).textTheme.labelSmall!.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color),),
          ),
          ...
          Expanded(
            child: ClipRRect(
              ...
              child: LinearProgressIndicator(
                minHeight: 6,
                color: warningColor,
                backgroundColor: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(0.05),
                value: value,
              ),
            ),
          ),
