          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text("Avertir lorsque le produit est de retour en stock.", style: TextStyle(color: isNotify ? Colors.white : Theme.of(context).textTheme.bodyLarge!.color, fontWeight: FontWeight.bold)),
                ),
                CupertinoSwitch(
                  onChanged: onChanged,
                  value: isNotify,
